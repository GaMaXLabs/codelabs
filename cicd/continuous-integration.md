...
4.  **Configuración de Firebase Realtime Database (IMPORTANTE):**
    ...
    - **Activar Realtime Database:**
      ...
      - En el panel de navegación izquierdo de tu proyecto de Firebase, busca la sección "Todos los Productos" y haz clic en "Realtime Database".
    ...
    - **Obtener la URL de la Base de Datos:**
      ...
      - Una vez que se haya creado tu base de datos, verás la URL de la misma en la parte superior del panel de Realtime Database, en la pestaña de "Datos".
    ...
    - **Configurar el Archivo `.env`:**
      ...
      - Abre el archivo `.env` y agrega la URL de tu base de datos de Firebase de la siguiente manera:
        ...
        ```
        REACT_APP_FIREBASE_RTDB_URL=https://tu-proyecto-default-rtdb.firebaseio.com/
        ```
...
8.  **Dar Permisos al Compañero de Equipo:**
    ...
    - El "Contributor" debe agregar al "Reviewer" como colaborador en su repositorio forked.
      - Ve a la pestaña "Settings" o "Configuración" del repositorio forkeado en la página web de GitHub.
      - Selecciona "Collaborators" o "Colaboradores" y añade el nombre de usuario de GitHub del "Reviewer".

9.  **Asegúrate que el Reviewer acepte la invitación**

    - El "Reviewer" recibirá un correo electrónico que contendrá instrucciones para aceptar ser colaborador en el repositorio. Asegúrate de que siga las instrucciones recibidas.
...
11. **Implementar la Funcionalidad y Empujar los Cambios:**
    ...
    - **Agrega el siguiente código dentro del componente Menu, antes de la línea que cierra el componente </Menu>:**
    ...
    ```
    ```bash
    # Guarda cambios y verifica el estado de Git
    git status
    ```

    ```bash
    # Realiza tus modificaciones y agrégalas a la zona de preparación de Git
    git add .

     # Verifica el estado de Git de nuevo
    git status

    # Crea un commit con los cambios que realizaste
...
12. **Crear un Pull Request:**
    ...
    - Ve a tu repositorio en la página web de GitHub y crea un pull request desde tu rama `feature/restore-completed-tasks` hacia la rama `main`.
      - En la pestaña de Code, aparecerá un cuadro de diálogo para "Comparar y pull request". Haz  click en el botón.
      - Asegúrate de que el repositorio base y el repositorio cabeza sean ambos [tu-usuario-de-github]/todo-list. 
    - Asigna al compañero que elegiste como "Reviewer" como revisor del pull request. Deja los otros valores por defecto y haz click en "Crear Pull Request"

13. **Validar los Checks de Integración (Antes de Configurar CI):**
...
14. **Pide al Reviewer revisar el Pull Request (Antes de Configurar CI):**
...
15. **Aprobar o Solicitar Cambios:**
...
16. **Resolver Comentarios (si es necesario):**
...
## Configuración de GitHub Actions para Integración Continua (CI)

17. **Crear el Workflow de GitHub Actions:**

    - Ahora, después de haber creado el pull request y haber tenido la experiencia de revisarlo (sin Integración Continua), vamos a configurar GitHub Actions para automatizar este proceso.
    - Cambia a la rama "main" ejecutando el código:
    ```bash
    git checkout main
    ```
...
18. **Configurar el archivo `ci.yml` con explicaciones paso a paso:**
...
19. **Commit y Push del Workflow:**

    - Agrega el archivo `ci.yml` a tu repositorio, guarda, haz commit y push a la rama `main`.
...
20. **Verificar la Ejecución del Workflow:**

    - Ve a la pestaña "Actions" en tu repositorio de GitHub.
    - Deberías ver la ejecución del workflow "Build and Test". Puedes en encontrar el workflow que tiene ese nombre en la parte izquierda de la pantalla. 
...
21. **Validar los Checks de Integración (Después de Configurar CI):**
...
22. **Revisar el Pull Request (Después de Configurar CI):**
...
23. **Aprobar o Solicitar Cambios:**
...
24. **Resolver Comentarios (si es necesario):**

    - Si el "Reviewer" solicitó cambios, realiza las modificaciones necesarias y actualiza el pull request.
    - Una vez que el "Reviewer" apruebe, puedes hacer merge del pull request a la rama `main`. Haz click en el botón "Merge Pull Request" y confirma el unido de la rama.
    - Observa que el ícono del Pull Request cambió a "Unido" o "Merged".

25. **Observar la Pipeline (Final - Después del Merge):**
